...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"<b> Hai 👋 {message.from_user.mention} </b>😍\n📁 𝗙𝗼𝘂𝗻𝗱 ✨  𝗙𝗶𝗹𝗲𝘀 𝗙𝗼𝗿 𝗬𝗼𝘂𝗿 𝗤𝘂𝗲𝗿𝘆 : #{search}</i>👇🏻\n\n<b>ഈ ബോട്ടിൽ തീയറ്റർ പ്രിന്റ് [PreDVD] മാത്രമേ കിട്ടുകയുള്ളൂ</b>"
